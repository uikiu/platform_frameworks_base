...
public final class ViewRootImpl implements ViewParent,
     ...
     * spec 规范。
     *
     * @param childWidthMeasureSpec:横向测量规范MeasureSpec
     * @param childHeightMeasureSpec:纵向测量规范MeasureSpec
     */
     ...
     *                      window.
     * @param rootDimension 布局参数，间接指定了测量模式。
     * @return The measure spec to use to measure the root view.
     * ---------------------------------------------------------------------------------------------
     * 根据view的layout params计算出窗口中根视图的度量规格。
     * 说白了就是先向父窗体做个申请，确定自己的可活动范围。
     * 当我们在xml当中配置控件的layout_width和layout_height值就指定了在父View中的布局参数，间接指定了测量模式。
     * ---------------------------------------------------------------------------------------------
     * 翻译：Dimension 尺寸。
     */
    private static int getRootMeasureSpec(int windowSize, int rootDimension) {
        ...
        switch (rootDimension) {
            ...
            case ViewGroup.LayoutParams.MATCH_PARENT:
                // Window can't resize. Force root view to be windowSize:窗口无法调整大小。 强制根视图为windowSize。
                measureSpec = MeasureSpec.makeMeasureSpec(windowSize, MeasureSpec.EXACTLY);
                break;

            case ViewGroup.LayoutParams.WRAP_CONTENT:
                // Window can resize. Set max size for root view:窗口可以调整大小。 设置根视图的最大大小。
                measureSpec = MeasureSpec.makeMeasureSpec(windowSize, MeasureSpec.AT_MOST);
                break;

            default:
                // Window wants to be an exact size. Force root view to be that size：窗口想成为一个确定的大小。 强制根视图是这个大小。
